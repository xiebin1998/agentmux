...
export default function EventStream({ refreshToken }: EventStreamProps) {
  ...
  const fetchPage = useCallback(
    ...
    [keyword, malformedOnly, sinceDate, untilDate],
  );
  ...
  const filtered = kind ? events.filter((e) => e.listen_kind === kind) : events;
              ...
              return (
                ...
                >
                  <div style={{ padding: "8px 12px" }}>
                    ...
                    >
                      <span style={{ color: "var(--accent)" }}>{event.listen_kind}</span>
                      ...
                      {event.reply_status === "failed" && (
                        <span style={{ color: "var(--danger)" }}>回复失败</span>
                      )}
                      <button
